...
class SheetLogic(QMainWindow,Ui_MainWindow2):
    ...
    def __init__(self,name):
        ...
        with open('Rangers.csv') as csvfile:
            ...
            self.CharHDisplay.setText(f'Health: {CharDataS[0][7]}')
            self.CharMSDisplay.setText(f'Move Speed:{CharDataS[0][8]}')
            self.CharPDisplay.setText(f'Personal Power: {CharDataS[0][9]}')
